  ...
  Widget build(BuildContext context) {
    return Consumer<MeetingProvider>(
      builder: (context, provider, _) {
        final isPlaying = provider.isPlaying && provider.currentlyPlayingId == meeting.id;
        final pos = provider.currentlyPlayingId == meeting.id ? provider.playbackPosition : Duration.zero;
        final dur = provider.currentlyPlayingId == meeting.id ? provider.totalDuration : Duration.zero;
